...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    $query = "SELECT l.component_id, l.added_quantity, l.pulled_quantity, l.add_date, l.pull_date, s.manu_part_num "
            . "FROM log_component as l RIGHT JOIN store as s "
    ...
    <table class="table table-striped">
        ...
        if (count($data)) {
            foreach ($data as $key => $value) {
                if ($value['added_quantity']) {
                    echo '<tr class="success">
                        <td class="text-left" style="font-size: 24;"><span style="font-weight: bold;">' . $value['added_quantity'] . '</span> pieces added at <span style="font-weight: bold;"> ' . $value['add_date'] . '</span></td></tr>';
                } else {
            ...
            echo '<tr class="info"><td class="text-left" style="font-size: 24;">There is no log details for this component</td></tr>';
        }
        ?>
