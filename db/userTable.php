...
if (isset($_REQUEST['add_user']) || isset($_REQUEST['update_user'])|| isset($_REQUEST['admin_update_user'])) {
    ...
    if (isset($_REQUEST['add_user'])) {
        ...
        $query = "UPDATE user SET name = '$name', user_name ='$user_name', email = '$email', password = '$password', gender = '$gender', position = '$position' WHERE id = $id";
    } elseif (isset($_REQUEST['admin_update_user'])) {
        $id = mysqli_real_escape_string($link, $_REQUEST['id']);
        $query = "UPDATE user SET name = '$name', user_name ='$user_name', email = '$email', gender = '$gender', position = '$position' WHERE id = $id";
    }
