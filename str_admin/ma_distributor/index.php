...
<div class="row">
    <div class="col-sm-offset-4 col-sm-4 text-center" style="font-size: 22px; font-weight: bold; color: #d9534f;">distributors</div>
</div>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            foreach ($data as $key => $value) {
                ...
                . '<a href="http://localhost/EwestStore/distributor/show.php?id=' . $value['id'] . '"  class="btn btn-success" name="show" style="margin:5px;">show</a>'
                . '<a href="http://localhost/EwestStore/distributor/edit.php?id=' . $value['id'] . '" class="btn btn-warning" name="update" style="margin:5px;">Edit</a>'
