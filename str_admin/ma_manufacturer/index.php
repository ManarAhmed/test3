...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-industry"></i> Manufacturers</h3>
    </div>
</div>
<section class="panel">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        . '<a href="http://localhost/EwestStore/str_admin/ma_manufacturer/show.php?id=' . $value['id'] . '"  class="btn btn-success" name="show" style="margin:5px;">show</a>'
                        . '<a href="http://localhost/EwestStore/str_admin/ma_manufacturer/edit.php?id=' . $value['id'] . '" class="btn btn-warning" name="update" style="margin:5px;">Edit</a>'
