...
if (!empty($data)) {
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <a href="http://localhost/EwestStore/str_admin/ma_log_component/show.php?id=<?php echo $data[0]['id']; ?>" class="btn btn-success" name="log" style="margin:5px;">Log Details</a>
